...
$TRIMED_FILE_LEN = 784
$SOURCE_SESSION_DIR = "Benign\2_Session\AllLayers"
...
foreach($d in $dirs)
{
    ...
    {             
        ...
        $path_test  = "Benign\3_ProcessedSession\FilteredSession\Test\$($d.Name)"
        $path_train = "Benign\3_ProcessedSession\FilteredSession\Train\$($d.Name)"
...
$paths = @(('Benign\3_ProcessedSession\FilteredSession\Train', 'Benign\3_ProcessedSession\TrimedSession\Train'), ('Benign\3_ProcessedSession\FilteredSession\Test', 'Benign\3_ProcessedSession\TrimedSession\Test'))
foreach($p in $paths)
{
